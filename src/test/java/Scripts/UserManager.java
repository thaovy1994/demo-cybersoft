...
//        RegisterPage registerPage = new RegisterPage(driver);
//        registerPage.uncheckBox("mina","mina1@gmail.com","abc123","abc123","0790512345","2000-12-25");
//    }

    @Test
    public void verifyExistingEmail(){
        RegisterPage registerPage = new RegisterPage(driver);
        registerPage.checkExistingEmail("mina","mina@gmail.com","abc123","abc123","0790512345","2000-12-25");
    }
}
